...
![Licence](https://img.shields.io/badge/licence-AGPL V3-green) ![PWA](https://img.shields.io/badge/PWA-ready-4a9e68) ![OpenStreetMap](https://img.shields.io/badge/carte-OpenStreetMap-blue) ![Sans clé API](https://img.shields.io/badge/API_key-aucune-brightgreen)
...
4. Confirmez avec à nouveau **"Installer"**— FreTrack apparaît comme une vraie application
